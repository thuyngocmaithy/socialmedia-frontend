...
export const UserGroupActiveIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    ...
    >
        <path
            d='M25.5 17C25.5 21.1421 22.1421 24.5 18 24.5C13.8579 24.5 10.5 21.1421 10.5 17C10.5 12.8579 13.8579 9.5 18 9.5C22.1421 9.5 25.5 12.8579 25.5 17Z'></path>
        <path
            d='M7.10396 34.7906C8.78769 30.2189 12.8204 27 18.0009 27C23.1818 27 27.2107 30.2213 28.8958 34.7898C29.3075 35.906 28.6141 37 27.5 37H8.5C7.38629 37 6.69289 35.9067 7.10396 34.7906Z'></path>
        <path
            d='M40.6308 37H32C31.2264 34.1633 30.0098 31.5927 28.144 29.7682C29.5384 28.9406 31.1829 28.5 33 28.5C37.239 28.5 40.536 30.8992 41.9148 35.0108C42.2516 36.0154 41.5423 37 40.6308 37Z'></path>
        <path
            d='M33 26.5C36.0376 26.5 38.5 24.0376 38.5 21C38.5 17.9624 36.0376 15.5 33 15.5C29.9624 15.5 27.5 17.9624 27.5 21C27.5 24.0376 29.9624 26.5 33 26.5Z'></path>
    </svg>
);
...
export const ArowLeftIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        xmlns='http://www.w3.org/2000/svg'
        className={className}
        width={width}
...
export const ArowRightIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        xmlns='http://www.w3.org/2000/svg'
        className={className}
        width={width}
...
export const LogoPinterest = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const NotificationIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    ...
    >
        <path
            d='M12 24c-1.66 0-3-1.34-3-3h6c0 1.66-1.34 3-3 3zm7-10.83c1.58 1.52 2.67 3.55 3 5.83H2c.33-2.28 1.42-4.31 3-5.83V7c0-3.87 3.13-7 7-7s7 3.13 7 7v6.17z'></path>
    </svg>
);
...
export const MessageIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    ...
    >
        <path
            d='M18 12.5a1.5 1.5 0 1 1 .001-3.001A1.5 1.5 0 0 1 18 12.5m-6 0a1.5 1.5 0 1 1 .001-3.001A1.5 1.5 0 0 1 12 12.5m-6 0a1.5 1.5 0 1 1 .001-3.001A1.5 1.5 0 0 1 6 12.5M12 0C5.925 0 1 4.925 1 11c0 2.653.94 5.086 2.504 6.986L2 24l5.336-3.049A10.93 10.93 0 0 0 12 22c6.075 0 11-4.925 11-11S18.075 0 12 0'></path>
    </svg>
);
export const EditIcon = ({ width = '1.6rem', height = '1.6rem', className }) => (
    ...
    >
        <path
            d='m13.386 6.018 4.596 4.596L7.097 21.499 1 22.999l1.501-6.096L13.386 6.018zm8.662-4.066a3.248 3.248 0 0 1 0 4.596l-2.298 2.3-4.596-4.598 2.298-2.299a3.248 3.248 0 0 1 4.596 0z'></path>
    </svg>
);
...
export const ShareIcon = ({ width = '1.6rem', height = '1.6rem', className }) => (
    ...
    >
        <path
            d='M21 14c1.1 0 2 .9 2 2v6c0 1.1-.9 2-2 2H3c-1.1 0-2-.9-2-2v-6c0-1.1.9-2 2-2s2 .9 2 2v4h14v-4c0-1.1.9-2 2-2zM8.82 8.84c-.78.78-2.05.79-2.83 0-.78-.78-.79-2.04-.01-2.82L11.99 0l6.02 6.01c.78.78.79 2.05.01 2.83-.78.78-2.05.79-2.83 0l-1.2-1.19v6.18a2 2 0 1 1-4 0V7.66L8.82 8.84z'></path>
    </svg>
);
...
export const AccessIcon = ({ width = '0.9rem', height = '0.9rem', className }) => (
    <svg className={className} width={width} height={height} viewBox='0 0 24 24' aria-label='liên kết' role='img'>
        <path
            d='M4.928 1a2.357 2.357 0 1 0 0 4.714h10.024L1.69 18.976a2.36 2.36 0 0 0 0 3.334 2.35 2.35 0 0 0 1.668.69c.603 0 1.206-.229 1.667-.69l13.26-13.263v10.024a2.358 2.358 0 1 0 4.715 0V1H4.928Z'></path>
    </svg>
);
...
export const FilterIcon = ({ width = '2rem', height = '2rem', className }) => (
    ...
    >
        <path
            d='M9 19.5a1.75 1.75 0 1 1 .001-3.501A1.75 1.75 0 0 1 9 19.5M22.25 16h-8.321c-.724-2.034-2.646-3.5-4.929-3.5S4.795 13.966 4.071 16H1.75a1.75 1.75 0 0 0 0 3.5h2.321C4.795 21.534 6.717 23 9 23s4.205-1.466 4.929-3.5h8.321a1.75 1.75 0 0 0 0-3.5M15 4.5a1.75 1.75 0 1 1-.001 3.501A1.75 1.75 0 0 1 15 4.5M1.75 8h8.321c.724 2.034 2.646 3.5 4.929 3.5s4.205-1.466 4.929-3.5h2.321a1.75 1.75 0 0 0 0-3.5h-2.321C19.205 2.466 17.283 1 15 1s-4.205 1.466-4.929 3.5H1.75a1.75 1.75 0 0 0 0 3.5'></path>
    </svg>
);
...
export const SelectedIcon = ({ width = '1.2rem', height = '1.2rem', className }) => (
    <svg className={className} width={width} height={height} viewBox='0 0 24 24' aria-label='Selected item' role='img'>
        <path
            d='M9.17 21.75.73 12.79c-.97-1.04-.97-2.71 0-3.75a2.403 2.403 0 0 1 3.53 0l4.91 5.22L19.74 3.03c.98-1.04 2.55-1.04 3.53 0 .97 1.03.97 2.71 0 3.74L9.17 21.75z'></path>
    </svg>
);
...
export const SearchIcon = ({ className }) => (
    <div className={className} style={
        ...
        <svg height='20' width='20' viewBox='0 0 24 24' aria-hidden='true' aria-label=''
             role='img'>
            <path
                d='M10 16c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6m13.12 2.88-4.26-4.26A9.842 9.842 0 0 0 20 10c0-5.52-4.48-10-10-10S0 4.48 0 10s4.48 10 10 10c1.67 0 3.24-.41 4.62-1.14l4.26 4.26a3 3 0 0 0 4.24 0 3 3 0 0 0 0-4.24'></path>
        </svg>
    </div>
...
export const People = ({ className }) => (
    <div className={className} style={
        ...
        <svg style={{
            display: 'block',
            margin: 'auto',
        }} height='20' width='20' viewBox='0 0 24 24' aria-hidden='true' aria-label=''
             role='img'>
            <path
                d='M8 11a4.5 4.5 0 1 1 0-9 4.5 4.5 0 0 1 0 9zm10 3c3.314 0 6 2.713 6 6.061V22H0v-1.919C0 15.618 3.582 12 8 12c2.614 0 4.927 1.272 6.387 3.23A5.927 5.927 0 0 1 18 14zm0-1a3.25 3.25 0 1 1 0-6.5 3.25 3.25 0 0 1 0 6.5z'></path>
        </svg>
    </div>
